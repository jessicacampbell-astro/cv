...
% LATTES
%\textit{2019} & \textbf{Cosmological Analyses Featuring galactic Foreground Emission}; Lattes, France \\
% New Perspectives on Galactic Magnetism
\textit{2019} & \textbf{New Perspectives on Galactic Magnetism}; University of Newcastle upon Tyne, England \\
% Big Apple Magnetic Fields
...
\begin{table}[h!]
\begin{tabularx}{\textwidth}{lX}
% VLA Synthesis Imaging Workshop
%\textit{2020} & \textbf{VLA Synthesis Imaging Workshop}, New Mexico Institute of Mining and Technology (NMT), Socorro, New Mexico \\
% IAR workshop
\textit{2019} & \textbf{Identify, Assist, Refer (IAR) Workshop}, Department of Astronomy \& Astrophysics, UofT \\
