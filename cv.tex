...
{\bf Ph.D.}, Astronomy \& Astrophysics \hfill \textit{2016 -- current} \\
Department of Astronomy \& Astrophysics, University of Toronto, Toronto, ON \\
Preliminary thesis entitled ``\textit{Polarimetry and 21 cm HI as a Probe of Galactic Magnetism in a Multiphase Interstellar Medium}'' supervised by Bryan Gaensler (UofT) and Susan Clark (IAS)
...
\textit{2020} & \textbf{CASCA iPoster Prize}, CASCA Board \\
% CASCA poster (GSC)
\textit{2020} & \textbf{CASCA iPoster Prize}, CASCA GSC \\
% Reinhardt fund
\textit{Summer 2019} & \textbf{Reinhardt Fund Award}, Department of Astronomy \& Astrophysics, UofT \\
% Dundies
\textit{2018} & \textbf{Above and Beyond Dundies Award}, Dunlap Institute for Astronomy \& Astrophysics, UofT \\
% UofT Fellowship
...
\newpage
\section{\Large Student Supervision}
\vspace{-5pt} % Gap between title and line
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.4pt}}
\vspace{-20pt} % Gap between title and text
...
%                          2020-2021
% Parampreet Singh
\textit{2020 -- 2021} & \textbf{Parampreet Singh}, undergraduate thesis (AST425Y) 
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{lX}
% CASCA
 \textit{2020} & \textbf{CASCA}; York University, online \\
...
\textit{2020} & \textbf{Graduate Student Panel}, Astronomy Student Union, UofT \\
% TMT Statement Committee
\textit{2019 -- 2020} & \textbf{TMT Statement Committee}, GASA, UofT (elected) \\
% PRISM
\textit{2019 -- 2020} & \textbf{People Representing Intersectional Spectral Minorities}, GASA, UofT (elected) \\
% DMC Student Rep
\textit{2018 -- 2020} & \textbf{Dunlap Management Committee Student Representative}, DADDAA, UofT (elected) \\
...
% GASA CUPE Rep.
\textit{2016 --  2018} & \textbf{CUPE Local 3902 Unit 1 Representative}, GASA, UofT (elected) \\
% DDC
...
\textit{2017 -- 2018} & \textbf{Mediation Committee}, GASA, UofT (elected) \\
% GASA Course Committee
\textit{2017 -- 2018} & \textbf{Graduate Course Committee}, GASA, UofT (elected) \\
% GASA Mental Health Committee
\textit{2017 -- 2018} & \textbf{Mental Health Committee}, GASA, UofT (elected) \\
% Dunlap Associate
...
\begin{tabularx}{\textwidth}{lX}
% Dunlap Retreat 
%\textit{2020} & \textbf{Dunlap Annual Retreat}, Dunlap, UofT \\
% IAR workshop
\textit{2020} & \textbf{Developing Effective Mentoring Practices in the Academy}, Ryerson University \& Dunlap, UofT \\
% IAR workshop
